...
<a
  target="_blank"
  rel="noopener"
  href="https://github.com/abhijit-kar/snowtail"
  style="position: fixed; top: 0; right: 0; border: 0; z-index: 9999; width:
  149px; height: 149px;">
  <img
    loading="lazy"
    width="149"
...
<main
  class="w-11/12 mb-6 xs:w-10/12 sm:w-9/12 md:w-8/12 lg:w-7/12 xl:w-6/12
  2xl:2-5/12">
  <section class="relative p-8 mb-6 bg-white rounded-lg shadow-2xl">
    <div class="relative flex flex-col justify-between inline-block text-left">
      <div class="flex mb-5">
        <label
          for="company_website"
          class="inline-flex items-center px-3 px-4 py-2 text-sm text-gray-500
          ...
          <svg
            ...
            <path
              ...
              1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z"
              clip-rule="evenodd" />
          </svg>
        </label>
  ...
  <section class="relative p-8 pb-3 bg-white rounded-lg shadow-2xl">
        ...
        <thead class="text-left text-center">
          <tr class="text-gray-500 border-b border-gray-300">
            ...
            <th
              ...
              title="For A/B Testing Same Link">
              Content
            </th>
    ...
    <textarea
      class="w-full text-center text-gray-400 outline-none focus:ring-2
...
<footer class="mb-3">
  <button
    class="mb-6 text-indigo-900 select-none dark:text-white focus:outline-none">
    <svg
      class="inline-block cursor-pointer fill-current"
      width="24"
      height="24"
      viewBox="0 0 48 48"
      fill="none"
  ...
  <section
    class="flex justify-center p-5 mb-2 mb-6 text-xs text-gray-900 bg-white
    ...
    <div class="w-2/5 mr-2">
      <a
        ...
        <figure>
          <img
            src="https://d2gdx5nv84sdx2.cloudfront.net/uploads/pq6gukie/marketing_asset/banner/4835/ghost-squircle.png"
            alt="Ghost Pro"
            border="0"
            class="mb-2" />
    ...
    <div class="flex flex-col justify-around w-4/5">
      ...
      <div>
        ...
        <a
          ...
          href="https://www.derpycoder.com/disclosure/"
          target="_blank"
          rel="noopener">
          Disclosure Policy
        </a>
